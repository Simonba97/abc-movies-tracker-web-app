...
const FavoriteMovie = ({ movieDetail }: { movieDetail: IMovieItem }) => {
    ...
    const handleFavoriteClick = (movie: IMovieItem) => {
    ...
    if (isFavorite(movieDetail.id)) {
        /* Componente de Marcado como Favorito */
        return (
            <button className='w-10 sm:w-12 lg:w-14 bg-gray-100 fill-yellow-500 rounded-br-lg absolute shadow-xl' onClick={() => handleFavoriteClick(movieDetail)}>
        ...
        return (
            <button className='w-10 sm:w-12 lg:w-14 bg-gray-100 fill-gray-700 rounded-br-lg absolute shadow-xl' onClick={() => handleFavoriteClick(movieDetail)}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
